...
因此，当前 A100 forward-only 分支在 h256 上已经达到继续投入的门槛。下一阶段可以
围绕 h256 继续压低 forward 开销，也可以开始设计 h256 backward 的正确性和性能原型。
...
4. 开始 h256 backward 原型设计，先只覆盖单层、单向、fp32、batch-first。
